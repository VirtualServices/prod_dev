<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'checkin-nm');
	...
	$rss->title = 'Most recently checked-in items at the North Main Branch, Richland County Public Library';
	$rss->description = 'Most recently checked-in items at the North Main Branch. Click a title to place a hold request.';
