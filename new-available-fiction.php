<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'new-available-fiction');
	...
	$rss->title = 'Available new fiction books at the Richland County Public Library';
	$rss->description = 'Available new fiction books at RCPL.  Click on a title to place a hold request on that item.';
