<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'checkin-ba');
	...
	$rss->title = 'Most recently checked-in items at the Link, Ballentine, Richland County Public Library';
	$rss->description = 'Most recently checked-in items at the Link, Ballentine. Click a title to place a hold request.';
