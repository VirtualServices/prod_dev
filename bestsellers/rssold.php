...
?>
  ...
  <link><?=YOUR_WEBSITE_URL?></link>
  <description>New York Times Bestseller List <?=$titlez?> Hardback</description> 
...
foreach($itemsXml as $item){
	...
	"\t<link><![CDATA[http://hip.richland.lib.sc.us/ipac20/ipac.jsp?menu=search&aspect=basic_search&npp=20&ipp=20&spp=20&profile=int&ri=&index=.EK&term=".$item['isbn']."&x=12&y=17&aspect=basic_search]]></link>\n" . 
	"\t<rank><![CDATA[".$i."]]></rank>\n" . 
	"\t<cover><![CDATA[http://contentcafe.btol.com/Jacket/Jacket.aspx?SysID=ebsrichland&CustID=richland&Key=".$item['isbn']."&Type=S]]></cover>\n" . 
