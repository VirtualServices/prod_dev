<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'mostrequested-children');
	...
	$rss->title = 'Most requested childrens items at the Richland County Public Library';
	$rss->description = 'List of the childrens items from our catalog with the most hold requests.';
...
where   a11.bib_id = a12.bib_id and 
        ...
        (a13.collection in('j','jb','jbc','jbcf','jbd','jc','jcd','jcf','jdvd','je','jgn','jnf','jpb','jply','jtb','jtbf','jtcd','jtcdf','juv','jvc')and 
