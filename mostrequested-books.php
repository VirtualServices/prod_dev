<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'mostrequested-books');
	...
	$rss->title = 'Most requested books at the Richland County Public Library';
	$rss->description = 'List of the books from our catalog with the most hold requests';
...
where   a11.bib_id = a12.bib_id and 
        ...
        (a13.collection in('b','f','gn','le','leb','lef','m','nr','os', 'pb','sf','w')and 
