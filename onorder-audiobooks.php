<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-audiobooks');
	...
	$rss->title = 'Most recently ordered adult audiobooks at the Richland County Public Library';
	$rss->description = 'Most recently ordered adult audiobooks for our collection. Click on a title to place a hold request on that item.';
...
where   a11.bib_id = a12.bib_id and 
        ...
        (a13.collection in ('tcd','tcdf','letb','letbf')and 
