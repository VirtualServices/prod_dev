<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-mystery');
	...
	$rss->title = 'Most recently ordered adult mystery books at the Richland County Public Library';
	$rss->description = 'Most recently ordered adult mystery books for our collection.  Click on a title to place a hold request on that item.';
