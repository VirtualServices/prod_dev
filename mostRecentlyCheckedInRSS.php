<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'mostRecentlyCheckedInRSS');
	...
	$rss->title = 'Most recently checked-in books at the Richland County Public Library';
	$rss->description = 'Most recently checked-in books in our catalog. Click a title to place a hold request.';
...
and item.item_status='i' 
	and item.collection in ('b','gen','gn','le','leb','lef','m','lh','lhb','lhf','nf','nr','or','os','pb','per','sf','w'
)
