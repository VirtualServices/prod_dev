<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'checkin-bw');
	...
	$rss->title = 'Most recently checked-in items at the Blythewood Branch, Richland County Public Library';
	$rss->description = 'Most recently checked-in items at the Blythewood Branch. Click a title to place a hold request.';
