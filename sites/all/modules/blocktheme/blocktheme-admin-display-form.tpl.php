<?php
// $Id: blocktheme-admin-display-form.tpl.php,v 1.1.2.1 2010/11/09 01:11:34 amateescu Exp $
 ...
 * - $data->custom_block_theme: Custom theme name (if defined).
...
<table id="blocks" class="sticky-enabled">
  <thead>
    <tr>
      ...
      <th><?php print t('Custom Theme'); ?></th>
  ...
  <tbody>
    ...
    <?php foreach ($block_regions as $region => $title): ?>
      ...
      <tr class="draggable <?php print $row % 2 == 0 ? 'odd' : 'even'; ?><?php print $data->row_class ? ' '. $data->row_class : ''; ?>">
        ...
        <td><?php print $data->custom_block_theme; ?></td>
