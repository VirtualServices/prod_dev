 ...
 */
Drupal.varlinkAutoAttach = function() {
  $('input.more-links').each(function() {
    ...
    var link = new Drupal.jsvarlink(uri, button, wrapper, counter);
  });
};
 ...
 * JS jsvarlink object.
 */
Drupal.jsvarlink = function(uri, button, wrapper, counter) {
  this.button = '#'+ button;
 ...
 */
Drupal.jsvarlink.prototype.onsubmit = function() {
  // Increment count
 ...
 */
Drupal.jsvarlink.prototype.oncomplete = function(data) {
 ...
 */
Drupal.jsvarlink.prototype.onerror = function(error) {
  alert('An error occurred:\n\n'+ error);
};

// Global killswitch
if (Drupal.jsEnabled) {
  $(document).ready(Drupal.varlinkAutoAttach);
};
