<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'checkin-sh');
	...
	$rss->title = 'Most recently checked-in items at the Sandhills Branch, Richland County Public Library';
	$rss->description = 'Most recently checked-in items at the Sandhills Branch. Click a title to place a hold request.';
