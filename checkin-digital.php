<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'checkin-digital');
	...
	$rss->title = 'Most recently checked-in digital media at the Richland County Public Library';
	$rss->description = 'Most recently checked-in digital media in our catalog';
...
and item.item_status='i' 
	and item.collection in ('bd', 'c', 'cd', 'cf', 'dvd', 'lebd', 'ledvd', 'mp3cd', 'mp3cdf', 'ply', 'romc', 'tb', 'tbf', 'tcd', 'tcdf', 'vc', 'vg')
