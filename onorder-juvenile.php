<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-juvenile');
	...
	$rss->title = 'Most recently ordered youth items at the Richland County Public Library';
	$rss->description = 'Most recently ordered youth items for our collection. Click on a title to place a hold request on that item.';
...
where   a11.bib_id = a12.bib_id and 
        ...
        (a13.collection in ('jdvd','jb','jbc','jbcf','jbd','jc','jcd','jcf','jdvd','je','jgn','jnf','jpb','jply','jref','jtb','jtbf','jtcd','jtcdf','juv','jvc')and 
