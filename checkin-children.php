<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'checkin-children');
	...
	$rss->title = 'Most recently checked-in children\'s items at the Richland County Public Library';
	$rss->description = 'Most recently checked-in children\'s items in our catalog';
...
and item.collection in ('j','jb','jbc','jbcf','jbd','jc','jcd','jcf','jdvd','je','jgn','jnf','jpb','jply','jtb','jtbf','jtcd','jtcdf','juv','jvc')
