<?php
	...
	$rss->title = 'Most recently ordered books at the Richland County Public Library';
	$rss->description = 'Most recently ordered books for our collection.  Click on a title to place a hold request on that item.';
...
where   a11.bib_id = a12.bib_id and 
        ...
        (a13.collection in ('f', 'nf', 'b', 'gn', 'le', 'leb', 'lef', 'lelp', 'lh', 'lhb', 'lhf', 'lp', 'lpb', 'lpf', 'lpm', 'lpsf', 'lpw', 'm', 'os', 'pb', 'sf', 'w')and 
