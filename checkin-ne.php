<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'checkin-ne');
	...
	$rss->title = 'Most recently checked-in items at the Northeast Regional Branch, Richland County Public Library';
	$rss->description = 'Most recently checked-in items at the Northeast Regional Branch. Click a title to place a hold request.';
