<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-biography');
	...
	$rss->title = 'Most recently ordered biographies at the Richland County Public Library';
	$rss->description = 'Most recently ordered biographies for our collection.  Click on a title to place a hold request on that item.';
