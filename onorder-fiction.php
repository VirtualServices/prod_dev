<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-fiction');
	...
	$rss->title = 'Most recently ordered adult fiction books at the Richland County Public Library';
	$rss->description = 'Most recently ordered adult fiction books for our collection.  Click on a title to place a hold request on that item.';
...
where   a11.bib_id = a12.bib_id and 
        ...
        (a13.collection in('f','lef','lhf')and 
