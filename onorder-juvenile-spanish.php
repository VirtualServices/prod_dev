<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-juvenile-spanish');
	...
	$rss->title = 'Most recently ordered juvenile spanish books at the Richland County Public Library';
	$rss->description = 'Most recently ordered juvenile spanish books for our collection. Click on a title to place a hold request on that item.';
...
where   a11.bib_id = a12.bib_id and 
        ...
        (a13.collection in ('spj','spje','spjnf')and 

        a12.creation_date between '01/01/2008' and '05/30/2019') and
