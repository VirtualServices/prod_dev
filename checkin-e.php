<?php
	...
	$rss->title = 'Most recently checked-in items at the Eastover Branch, Richland County Public Library';
	$rss->description = 'Most recently checked-in items at the Eastover Branch. Click a title to place a hold request.';
