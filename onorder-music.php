<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-music');
	...
	$rss->title = 'Most recently ordered music at the Richland County Public Library';
	$rss->description = 'Most recently ordered music for our collection. Click on a title to place a hold request on that item.';
