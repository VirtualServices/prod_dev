<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-nonfiction');
	...
	$rss->title = 'Most recently ordered adult nonfiction books at the Richland County Public Library';
	$rss->description = 'Most recently ordered adult nonfiction books for our collection.  Some items show duplicates because they have more than one isbn number.  Click on a title to place a hold request on that item.';
...
collection  a16 where a11.bib_id = a12.bib_id and a11.bib_id = a13.bib_id and a11.bib_id = a14.bib_id and a11.bib_id = a15.bib_id and a13.collection = a16.collection and (a13.collection in ('le', 'lh', 'nf')and (a14.processed IS NOT NULL) and a12.creation_date between '01/01/2009' and '05/30/2019') and
