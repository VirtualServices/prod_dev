<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'checkin-lp');
	...
	$rss->title = 'Most recently checked-in large print items at the Richland County Public Library';
	$rss->description = 'Most recently checked-in large print items in our catalog';
...
and item.item_status='i' 
	and item.collection in ('lelp', 'lp', 'lpb', 'lpf', 'lpm', 'lpsf', 'lpw')
