<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-playaway');
	...
	$rss->title = 'Most recently ordered playaways at the Richland County Public Library';
	$rss->description = 'Most recently ordered playaways for our collection. Click on a title to place a hold request on that item.';
