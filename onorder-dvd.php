<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-dvd');
	...
	$rss->title = 'Most recently ordered DVDs at the Richland County Public Library';
	$rss->description = 'Most recently ordered DVDs for our collection. Click on a title to place a hold request on that item.';
...
where   a11.bib_id = a12.bib_id and 
        ...
        (a13.collection in ('dvd','ledvd')and 
