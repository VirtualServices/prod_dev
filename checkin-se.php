<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'checkin-se');
	...
	$rss->title = 'Most recently checked-in items at the Southeast Regional Branch, Richland County Public Library';
	$rss->description = 'Most recently checked-in items at the Southeast Regional Branch. Click a title to place a hold request.';
