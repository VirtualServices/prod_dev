<?php
	...
	# RSS file name
	define('RSS_FILENAME', 'onorder-sci-fi');
	...
	$rss->title = 'Most recently ordered adult science fiction books at the Richland County Public Library';
	$rss->description = 'Most recently ordered adult science fiction books for our collection. Click on a title to place a hold request on that item.';
